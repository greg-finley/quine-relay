    (module
      ...
      (data(i32.const 0)"\28\00\00\00\01\00\00\00\2c\00\00\00\02\00\00\00\30\00\00\00\02\00\00\00\34\00\00\00\90\00\00\00\c4\00\00\00\55\00\00\00 ...\\t..\\n..(module(import\"wasi_snapshot_preview1\"\"fd_write\"(func(param i32 i32 i32 i32)(result i32)))(memory(export\"memory\")(data \"\\08\\00\\00\\00\\53\\00\\00\\00\"))(func(export\"_start\")i32.const 1 i32.const 0 i32.const 1 i32.const 0 call 0 drop))abcde")
      (func $out(param i32)
        i32.const 1
        local.get 0
        i32.const 8
